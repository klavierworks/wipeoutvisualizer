...
export type SpritePolygon = Extract<Polygon, { kind: 'sprite_bottom_anchor' } | { kind: 'sprite_top_anchor' }>
...
export const constructSprite = (polygon: SpritePolygon, vertices: Vertex[], textures: DataTexture[]): Mesh => {
