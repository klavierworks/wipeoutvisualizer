...
export type { AnalyzeResult, TempoSegment, SectionMarker } from './analyze.worker'

// Spawns the analysis worker, mixes the decoded buffer down to a single
// transferable Float32Array, and resolves when the worker posts back.
